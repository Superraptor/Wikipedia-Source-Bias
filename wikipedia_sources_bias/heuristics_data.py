...
# NOTE ON POLITICAL LEANING
#
# This table deliberately carries NO political_leaning field. It used to assert
# one for 70 of 76 domains -- "center-left", "far-right", "state-affiliated" --
# with no source, no date and no author: an editorial judgement about real news
# organisations, authored by us, invisible to any reader.
#
# A tool that audits Wikipedia's sourcing cannot itself be an unsourced rater
# of media bias. Leaning now comes only from attributed third parties:
#   1. Wikidata P1387 (political alignment) on the publisher item
#   2. Media Bias/Fact Check, which is cited as the source in the interface
# and is "unknown" when neither has an opinion. "Unknown" is a finding, not a
# gap to be filled in by us.
#
# Country, language, region and type remain: those are facts, not judgements.
DOMAIN_BIAS_DATABASE: dict[str, dict[str, Any]] = {
    ...
    "cairn.info": {
        "name": "Cairn.info", "country": "France", "region": "Europe", "reliability": "academic/peer-reviewed",
    ...
    "springeropen.com": {
        "name": "Springer Open", "country": "Germany", "region": "Europe", "reliability": "academic/peer-reviewed",
        "default_language": "English", "type": "academic_publisher",
    },
    "springer.com": {
        "name": "Springer", "country": "Germany", "region": "Europe", "reliability": "academic/peer-reviewed",
        "default_language": "English", "type": "academic_publisher",
    },
    "worldbank.org": {
        "name": "World Bank", "country": "United States", "region": "North America", "reliability": "high",
    ...
    "politico.eu": {
        "name": "Politico Europe", "country": "European Union", "region": "Europe", "reliability": "medium",
...
# Remove static reliability assumptions from DOMAIN_BIAS_DATABASE
for entry in DOMAIN_BIAS_DATABASE.values():
    entry.pop("reliability", None)
...
# Wikidata Country Population Data (in millions / exact estimates)
COUNTRY_POPULATION_DATA: dict[str, float] = {
    "China": 1411000000.0,
    "India": 1408000000.0,
    "United States": 332000000.0,
    "Indonesia": 273000000.0,
    "Pakistan": 231000000.0,
    "Brazil": 214000000.0,
    "Nigeria": 213000000.0,
    "Bangladesh": 169000000.0,
    "Russia": 143000000.0,
    "Mexico": 126000000.0,
    "Japan": 125000000.0,
    "Ethiopia": 120000000.0,
    "Philippines": 113000000.0,
    "Egypt": 104000000.0,
    "DR Congo": 95000000.0,
    "Vietnam": 97000000.0,
    "Iran": 87000000.0,
    ...
    "Germany": 84000000.0,
    "Thailand": 71000000.0,
    "United Kingdom": 67000000.0,
    "Tanzania": 63000000.0,
    "France": 68000000.0,
    "South Africa": 60000000.0,
    "Italy": 59000000.0,
    "Kenya": 54000000.0,
    "Myanmar": 54000000.0,
    "Colombia": 51000000.0,
    "South Korea": 51000000.0,
    "Uganda": 47000000.0,
    "Spain": 47000000.0,
    "Argentina": 45000000.0,
    "Algeria": 44000000.0,
    "Sudan": 45000000.0,
    "Ukraine": 43000000.0,
    "Iraq": 43000000.0,
    "Afghanistan": 41000000.0,
    "Poland": 38000000.0,
    "Canada": 38000000.0,
    "Morocco": 37000000.0,
    "Saudi Arabia": 36000000.0,
    "Uzbekistan": 36000000.0,
    "Peru": 33000000.0,
    "Angola": 34000000.0,
    "Malaysia": 33000000.0,
    "Ghana": 32000000.0,
    "Mozambique": 32000000.0,
    "Yemen": 31000000.0,
    "Nepal": 30000000.0,
    "Venezuela": 29000000.0,
    "Madagascar": 29000000.0,
    "Cameroon": 27000000.0,
    "Ivory Coast": 27000000.0,
    "North Korea": 26000000.0,
    "Australia": 26000000.0,
    "Niger": 25000000.0,
    "Taiwan": 23500000.0,
    "Sri Lanka": 22000000.0,
    "Burkina Faso": 22000000.0,
    "Mali": 21000000.0,
    "Romania": 19000000.0,
    "Chile": 19500000.0,
    "Kazakhstan": 19500000.0,
    "Zambia": 19000000.0,
    "Syria": 18000000.0,
    "Senegal": 17000000.0,
    "Netherlands": 17500000.0,
    "Guatemala": 17000000.0,
    "Ecuador": 17500000.0,
    "Zimbabwe": 15000000.0,
    "Cambodia": 16500000.0,
    "Greece": 10500000.0,
    "Czech Republic": 10700000.0,
    "Portugal": 10300000.0,
    "Sweden": 10400000.0,
    "Hungary": 9700000.0,
    "Belarus": 9300000.0,
    "Israel": 9300000.0,
    "Austria": 9000000.0,
    "Switzerland": 8700000.0,
    "Belgium": 11500000.0,
    "Jordan": 10200000.0,
    "United Arab Emirates": 9900000.0,
    "Denmark": 5800000.0,
    "Finland": 5500000.0,
    "Norway": 5400000.0,
    "Singapore": 5700000.0,
    "Ireland": 5000000.0,
    "New Zealand": 5100000.0,
}

# Key Regional Neighbor Mappings
COUNTRY_NEIGHBORS: dict[str, set[str]] = {
    "France": {"Germany", "Belgium", "Spain", "Italy", "Switzerland", "United Kingdom", "Luxembourg"},
    "United States": {"Canada", "Mexico", "United Kingdom"},
    "Canada": {"United States", "United Kingdom", "France"},
    "Germany": {"France", "Austria", "Switzerland", "Poland", "Czech Republic", "Netherlands", "Belgium", "Denmark"},
    "United Kingdom": {"Ireland", "France", "United States", "Germany"},
    "Russia": {"Ukraine", "Belarus", "Kazakhstan", "China", "Finland", "Poland"},
    "China": {"Japan", "Russia", "India", "South Korea", "Vietnam", "Taiwan", "Pakistan"},
    "India": {"Pakistan", "Bangladesh", "China", "Nepal", "Sri Lanka"},
    "Japan": {"China", "South Korea", "United States", "Taiwan"},
    "Brazil": {"Argentina", "Colombia", "Venezuela", "Peru", "Chile", "Uruguay"},
    "Australia": {"New Zealand", "United Kingdom", "United States", "Indonesia"},
    "Italy": {"France", "Switzerland", "Austria", "Greece", "Spain"},
    "Spain": {"France", "Portugal", "Italy", "Morocco"},
    "Ukraine": {"Russia", "Poland", "Belarus", "Germany", "Romania"},
}
